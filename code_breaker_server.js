...
app.post('/post', (req, res) => {
    ...
    if (z['action'] == "generateCode") { //generate a code for user
        idCounter++;
        ...
        res.send(jsontext);
    } else if (z['action'] == "evaluate") { //evaluate user's attempt
